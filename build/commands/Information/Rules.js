...
class Rules extends Command_1.Command {
    ...
    async run(client, msg, args) {
        ...
        const { rules, logChannel, prefix } = JSON.parse(db.dataValues.config);
        const serverLoggersChannel = msg.guild.channels.get(logChannel);
        if (!serverLoggersChannel) {
            return warningMessage(msg, `It appears that you do not have a Loggers channel.
